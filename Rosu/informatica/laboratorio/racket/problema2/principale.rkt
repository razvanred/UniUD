...
(define croce
  (glue-tiles
   (glue-tiles larger-tile (shift-right smaller-tile 2))
   (glue-tiles (shift-right (half-turn larger-tile) 2) (shift-right (shift-down (half-turn smaller-tile) 4) 2))
   ))

(define quadrato
  (glue-tiles
   (glue-tiles (shift-right (half-turn smaller-tile) 2) (shift-down (shift-right larger-tile 2) 1))
   (glue-tiles (shift-down (shift-right smaller-tile 2) 5) (half-turn larger-tile))
   ))

(glue-tiles (shift-right quadrato 7) croce)
