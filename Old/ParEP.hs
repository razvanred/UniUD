...
happyExpList = Happy_Data_Array.listArray (0,98) ([0,48,0,5,12288,0,0,0,128,0,0,0,0,4096,0,0,0,0,0,0,4096,0,0,0,0,32768,0,0,0,0,0,0,0,0,2048,0,48,0,5,16384,2,8704,0,0,0,0,12288,0,0,0,0,0,5,0,0,2048,0,0,0,8,12288,0,1280,0,1024,0,8,0,4,0,0,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pE","%start_pS","E","E1","ListE2","E2","E4","E3","Double","I","Integer","S","S1","ListS2","S2","S4","S3","String","int","double","string","'+'","'*'","'('","')'","%eof"]
...
action_11 (25) = happyShift action_22
...
happyReduction_12 (HappyTerminal (TokenDouble happy_var_1))
	 =  HappyAbsSyn11
		 (happy_var_1
	)
...
happyReduction_25 (HappyTerminal (TokenString happy_var_1))
	 =  HappyAbsSyn20
		 (happy_var_1
	)
