...
data HappyAbsSyn 
	...
	| HappyAbsSyn4 (Tree Int String)
	| HappyAbsSyn6 ([Tree Int String])
	| HappyAbsSyn10 (Int)
...
action_0,
 ...
 action_20,
 action_21,
 action_22 :: () => Prelude.Int -> ({-HappyReduction (HappyIdentity) = -}
	   Prelude.Int 
	-> (Token)
...
happyExpList = Happy_Data_Array.listArray (0,54) ([12288,32768,1,0,128,0,16384,0,0,0,0,0,0,32768,0,3,144,0,0,12288,0,0,16,96,8192,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","E","E1","ListE2","E2","E4","E3","I","String","Integer","int","string","'+'","'*'","'('","')'","%eof"]
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenString happy_dollar_dollar -> cont 14;
	TokenPlus -> cont 15;
	TokenTimes -> cont 16;
	OpenPar -> cont 17;
	ClosedPar -> cont 18;
