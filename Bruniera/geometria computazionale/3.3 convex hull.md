...
int recursiveConvexHull(PointVEctor &points, PointVector $hull) {
  ...
  //TODO vedi dai materiali del corso
}
...
L'appproccio statico all'algoritmo randomico utilizzando il grafo dei conflitti suggerisce un'altra soluzione con alcune differenze:
