...
Se devo stampare un valore all'interno di una stringa è semplice concatenare parti di una stringa con quella ritornata da `show x`. Per ragioni di efficienza si può usare `shows x "..."` che evita la concatenazione usando un accumulatore.
