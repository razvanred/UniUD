...
Esistono diverse versioni degli array, quelli che abbiamo visto sono immutabli e boxati. Haskell fornisce anche versioni unboxed (simili agli array di C), versioni che usano le monadi (mutabili), etc.
