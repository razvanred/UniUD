...
Ogni amministratore sceglie l'algorimto e le metriche del proprio AS. Niente ti impedisce di usare RIP su scala nazionale (se lo fai sei stupido) e gli altri sistemi devono essere ignari di questo.
