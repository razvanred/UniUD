...
public class Huffman {
  ...
  public static void main( String[] args ) {
    ...
    } else if ( args[0].equals("compress2") ) {
    
      System.out.println( "compressing..." );
      compress2( args[1], args[2] );
    
    } else if ( args[0].equals("decompress2") ) {
    
      System.out.println( "decompressing..." );
      decompress2( args[1], args[2] );
  ...
  public static Node huffmanTree2(){
    
    PriorityQueue<Node> queue = new PriorityQueue<Node>();
    
    queue.add(new Node('a',08167));
    queue.add(new Node('b',01492));
    queue.add(new Node('c',02782));
    queue.add(new Node('d',04253));
    queue.add(new Node('e',12702));
    queue.add(new Node('f',02228));
    queue.add(new Node('g',02015));
    queue.add(new Node('h',06094));
    queue.add(new Node('i',06966));
    queue.add(new Node('j',00153));
    queue.add(new Node('k',00772));
    queue.add(new Node('l',04025));
    queue.add(new Node('m',02406));
    queue.add(new Node('n',06749));
    queue.add(new Node('o',07507));
    queue.add(new Node('p',01929));
    queue.add(new Node('q',00095));
    queue.add(new Node('r',05987));
    queue.add(new Node('s',06327));
    queue.add(new Node('t',09056));
    queue.add(new Node('u',02758));
    queue.add(new Node('v',0978));
    queue.add(new Node('w',02361));
    queue.add(new Node('x',00150));
    queue.add(new Node('y',01974));
    queue.add(new Node('z',00074));
  ...
  public static void compress2( String src, String dst ) {
    
    // Scansione I : frequenze dei carattteri
    
    Node root = huffmanTree2( );                            // albero di Huffman
    ...
    in.close();
    in = new InputTextFile( src );            // documento originale
  ...
  public static void decompress2( String src, String dst ) {
    
    InputTextFile in = new InputTextFile( src );            // documento compresso
    
    int count = Integer.parseInt( in.readTextLine() );      // decodifica dell'intestazione
    Node root = huffmanTree2();
