...
Alcuni casi in cui mancanza di usabilità ha causato catastrogi:
...
* Militare: abbattimento erroneo di un aereo civile (volo Iran Air 655) da parte di una nave da guerra statunitense Vincennes
  ...
  * L'aereo era in realà un aereo di linea
...
* Aeronautico: la maggior parte degli incidenti di questo tipo sono nel settore aeronautico. In particolare, primi anni dell'Airbus 320
  * Fino agli '90 tutti gli strumenti erano analogici e le informazioni che un polota potrebbe cercare sono sempre nello stesso posto (si abbitua a dove buttare l'occhio). E si pilotano in modo diretto con una cloche
  ...
  * I piloti abbituati al modo precedente di volare hanno causato incidenti nei primi anni di introduzione.
...
* A: Tastierino numerico.
  ...
  * Più veloce
  * Più familiare
* A: Tasti + e - individuali per ogni cifra per impostare il numero una cifra alla volta
  * Più lento
  * Poco familiare
  * Se si sbaglia si può correggere
  * Richiede più attenzione dall'operatore

Nel contesto di uno strumendo ospedaliero design B verrebbe favorito, perché in caso di errore si può rimediare molto velocemente, in questo contesto la gestione dell'errore umano è più importante della velocità di utilizzo o familiarità.
...
* Icone proprietarie e non intuitive per funcioni con icone note come "start" e "stop"
* Interfaccie touch screen che non forniscono feedback tattile od utidivo per i tocchi
...
* Interfaccie con acronimi ed abbreviazioni troppo simili per farmaci diversi
