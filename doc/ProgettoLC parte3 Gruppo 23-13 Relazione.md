...
Oltre alla demo il cui risultato si può vedere con il comando `make demo`, nella cartella di test ci sono alcuni file di test che possono essere eseguiti. 
