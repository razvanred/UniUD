...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |Problema 6|) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp") (lib "drawings.ss" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp") (lib "drawings.ss" "installed-teachpacks")))))
...
(define L-tessellation
  (lambda (piastrellaBase)
    (if (= piastrellaBase 1)
        L-tile
        (glue-tiles
         (shift-right (quarter-turn-right (L-tessellation (quotient piastrellaBase 2))) piastrellaBase)
         (glue-tiles
          (shift-down (quarter-turn-left (L-tessellation (quotient piastrellaBase 2))) piastrellaBase)
          (glue-tiles
           (L-tessellation (quotient piastrellaBase 2))
           (shift-down (shift-right (L-tessellation (quotient piastrellaBase 2)) (quotient piastrellaBase 2)) (quotient piastrellaBase 2)))
          )
         ))
    ))
(L-tessellation 16)
