...
public class Huffman {
  ...
  public static void main( String[] args ) {
    ...
    System.out.println( "done." );*/
	  ...
	  int dim = getFileLength("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Huffman.java");
	  generateRandomFile("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Random.txt", dim);
	  generateHistogram("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Huffman.java", "C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\huffmanHistogram.txt");
	  generateHistogram("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Random.txt", "C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\RandomHistogram.txt");
	  System.out.println(getCompressedFileLength("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Huffman.java"));
	  System.out.println(getCompressedFileLength("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Random.txt"));
	  compress("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Huffman.java", "C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\compressedHuffman.txt");
	  decompress("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\compressedHuffman.txt", "C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\decompressedHuffman.txt");
	  compress("C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\Random.txt", "C:\\Users\\grand\\eclipse-workspace\\Huffman1\\src\\compressedRandom.txt");
  }
  //PARTE 1
  //Scrivi su file di output, gli ascii che usi, uno per riga :
  //codice ASCII, simbolo carattere, # occorrenze carattere, codice Huffman, lunghezza codice Huffman
  public static void generateHistogram(String src, String dst) {
	  int[] histogram = Huffman.charHistogram(src); //ASCII, # occorrenze
	  Node root = huffmanTree( histogram );//simbolo carattere, codice Huffman
	  String[] huffmanCodes = huffmanCodesTable(root);
	  OutputTextFile out = new OutputTextFile(dst);
	  for(int i = 0;i < out.CHARS; i++) {
		  if(huffmanCodes[i] != null) {
			  out.writeTextLine(i + "  " + (char) i + "  " + histogram[i] +"  "+ huffmanCodes[i] + "  " + huffmanCodes[i].length());
		  }
	  }
	  out.close();
  }
  ...
  //PARTE 2
  public static void generateRandomFile(String dst,int dim) {
	  OutputTextFile out = new OutputTextFile(dst);
	  double nRandom;
	  int nRandomInt;
	  char c;
	  ...
	  for(int i=0;i<dim;i++) {
		 nRandom = Math.random()*127;
		 nRandomInt = (int) nRandom;
  ...
  public static int getFileLength(String src) {
	  int[] freq = charHistogram( src );                      // istogramma delle frequenze
	  Node root = huffmanTree( freq );                        // albero di Huffman
	  int count = root.weight();                              // numero complessivo di caratteri
	  return count;
  ...
  //PARTE 3
  public static int getCompressedFileLength(String src) {
	  //lunghezza del contenuto del file compresso
	  int length = 0;
	  int[] histogram = Huffman.charHistogram(src); //ASCII, # occorrenze
	  Node root = huffmanTree( histogram );//simbolo carattere, codice Huffman
	  String[] huffmanCodes = huffmanCodesTable(root);
	  for(int i = 0;i < 128;i++) {
		  if(huffmanCodes[i]!= null) {
			  length = length + (histogram[i] * huffmanCodes[i].length());
		  }
	  }
	  length = length / 7;
	  //lunghezza dell'intestazione del file compresso
	  int count = root.weight(); 
	  String header = "" + count + flattenTree(root);
