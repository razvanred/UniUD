...
public class Huffman {
  ...
  public static int[] standardCharHistogram(){
  ...
  public static void compress( String src, String dst ) {
    ...
    public static void standardCompress( String src, String dst ) {
    // Scansione I : frequenze dei carattteri
    
    Node root = huffmanTree(standardCharHistogram());       // albero di Huffman
    ...
    while ( in.textAvailable() ) {                          // scansione: frequenze dei caratteri
      ...
      in.readChar();                                        // (ulteriore) occorrenza di c
      count++;
    }
...
//      System.out.println(c);
  ...
  public static void standardDecompress( String src, String dst ) {
    
    InputTextFile in = new InputTextFile( src );            // documento compresso
    
    int count = Integer.parseInt( in.readTextLine() );      // decodifica dell'intestazione
    Node root = huffmanTree(standardCharHistogram());
